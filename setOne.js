...
const parNames = (parameter1, parameter2) => `The first parameter ${parameter1}. The second parameter is ${parameter2}`

console.log(parNames("name1", "name2"));
...
greeting('Sheldon', ' Christiansen',callback)
